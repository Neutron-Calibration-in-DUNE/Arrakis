...
namespace arrakis
{
    ...
    void SimulationLabelingLogic::SetConfigurationParameters(const Parameters &config)
    {
        ...
        sFilterDetectorSimulation = std::to_string(config().FilterDetectorSimulation());
        Logger::GetInstance("SimulationLabelingLogic")->trace(
            "setting filter detector simulation to: " + sFilterDetectorSimulation
        );

        sNeutronCaptureGammaDetail = config().NeutronCaptureGammaDetail();
        Logger::GetInstance("SimulationLabelingLogic")->trace(
    ...
    Int_t SimulationLabelingLogic::IterateShapeLabel()
    {
        mShapeLabel += 1;
        return mShapeLabel;
    }
    ...
    void SimulationLabelingLogic::ProcessShowers(TrackID_List trackIDList, Int_t shapeLabel)
    {
